...
// Ferramentas contextuais. Permanecem disponíveis, mas saem do menu principal.
          ...
          <RequireAuth message="Faça login para acessar o sistema.">
            <Suspense fallback={<PageLoading />}>
              <Switch>
                ...
                {/* Ferramentas contextuais de catálogo */}
                ...
                {/* Ferramentas contextuais da oportunidade/proposta */}
                ...
                {/* Compatibilidade: URLs antigas passam a apontar para o fluxo novo */}
